...
<body class="skin-blue sidebar-mini"
	...
	<form method="post"
		action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/IncentiveGeneration.aspx"
		id="form1">
							...
							<div class="box box-info">
										...
										<td width="500px">
											<table style="width: 113%;">
												<tr>
													...
													<td colspan="3"><select
														name="ctl00$ContentPlaceHolder1$ddlVoucherMonth"
														onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$ContentPlaceHolder1$ddlVoucherMonth\&#39;,\&#39;\&#39;)&#39;, 0)"
														id="ContentPlaceHolder1_ddlVoucherMonth"
												...
												<tr>
													...
													<td><input
														name="ctl00$ContentPlaceHolder1$txtVDateFrom" type="text"
														readonly="readonly" id="ContentPlaceHolder1_txtVDateFrom"
														class="form-control" /></td>
													<td><strong>To</strong></td>
													<td class="style2"><input
														name="ctl00$ContentPlaceHolder1$txtVDateTo" type="text"
														readonly="readonly" id="ContentPlaceHolder1_txtVDateTo"
														class="form-control" /></td>
												</tr>
												<tr>
													<td class="style4">&nbsp;</td>
								...
								<div id="ContentPlaceHolder1_UpdatePanel2">
									...
									<table style="width: 100%; border-collapse: collapse;"
										...
										<tr>
											<th
												style="background-color: #bc3c3c; color: #fff; width: 60px;">Sl
												No.</th>
											<th align="left"
											...
											<th
												style="background-color: #bc3c3c; color: #fff; width: 80px;">&nbsp;
											</th>
										</tr>
										<tr>
											...
											<td style="width: 150px"><span
												id="ContentPlaceHolder1_lbl1"></span></td>
											<td style="width: 80px">&nbsp; <img
												id="ContentPlaceHolder1_img1" src="dist/img/ICOOffline.png"
												style="width: 16px;" />
											</td>
										</tr>
										<tr>
											...
											<td style="width: 150px"><span
												id="ContentPlaceHolder1_lbl2"></span></td>
											<td style="width: 80px">&nbsp; <img
												id="ContentPlaceHolder1_img2" src="dist/img/ICOOffline.png" />
											</td>
										</tr>
										<tr>
											...
											<td style="width: 150px"><span
												id="ContentPlaceHolder1_lbl3"></span></td>
											<td style="width: 80px">&nbsp; <img
												id="ContentPlaceHolder1_img3" src="dist/img/ICOOffline.png" />
											</td>
										</tr>
										<tr>
											...
											<td style="width: 150px"><span
												id="ContentPlaceHolder1_lbl4"></span></td>
											<td style="width: 80px">&nbsp; <img
												id="ContentPlaceHolder1_img4" src="dist/img/ICOOffline.png" />
											</td>
										</tr>
										<tr>
											...
											<td style="width: 150px"><span
												id="ContentPlaceHolder1_lbl5"></span></td>
											<td style="width: 80px">&nbsp; <img
												id="ContentPlaceHolder1_img5" src="dist/img/ICOOffline.png" />
											</td>
										</tr>
										...
										<tr>
											...
											<td style="width: 150px"><span
												id="ContentPlaceHolder1_lbl7"></span></td>
											<td style="width: 80px">&nbsp; <img
												id="ContentPlaceHolder1_img7" src="dist/img/ICOOffline.png" />
											</td>
										</tr>
										<tr>
											...
											<td style="width: 150px"><span
												id="ContentPlaceHolder1_lbl8"></span></td>
											<td style="width: 80px">&nbsp; <img
												id="ContentPlaceHolder1_img8" src="dist/img/ICOOffline.png" />
											</td>
										</tr>
									...
									<div style="vertical-align: middle">
										&nbsp;&nbsp;&nbsp; <img id="ContentPlaceHolder1_Image1"
											src="dist/img/Info.png" style="height: 50px; width: 50px;" />&nbsp;&nbsp;<span
											id="ContentPlaceHolder1_lblmsg"> Generating Commission
											Voucher is Time Consuming Process.</span> .
									</div>
								</div>
							</div>
						</div>
