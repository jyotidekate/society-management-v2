...
<body onload="getTheValueInTheDropDown()" class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
...
<form id="fileUploadForm">
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Select by Account No.<strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                        <select onchange="getthevalueinthegiveninputFieldsfofSavingAcoount()" name="accountNo"  id="accountNo" class="form-control select2" style="width: 100%;">
            ...
            <div class="col-md-10">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-5 control-label">Opening Date <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input name="opDate" type="date"  id="opDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5 control-label">Select by Member <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
	...
	<option value="01/NGP/ 000208">DIPAK RAJU HATWAR - 01/NGP/ 000208</option>
                            ...
                            <div class="form-group row">
                                <label for="txtRelativeName" class="col-sm-5 control-label">Member Name <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="memberName" type="text" readonly="readonly" id="memberName" class="form-control" Placeholder="Enter Member Name" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtDOB" class="col-sm-5 control-label">DOB <strong style="color: Red">*</strong></label>
                                <div class="col-sm-4">
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 control-label">Relative Details</label>
                                <div class="col-sm-7">
                                    <input name="relativeName" type="text" readonly="readonly" id="relativeName" class="form-control" Placeholder="Enter Relative Name &amp; Relation" />
                                </div>
                            </div>

                           
                            <div class="form-group row">
                                <label for="txtPhoneno" class="col-sm-5 control-label">Mobile No <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group row">
                                <label for="txtNomineeName" class="col-sm-5 control-label">Nominee Name</label>
                                <div class="col-sm-7">
                                    <input name="nomineeName" type="text" id="nomineeName" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtNomineeName" class="col-sm-5 control-label">Nominee Age</label>
                                <div class="col-sm-7">
                                    <input name="nage" type="text" maxlength="2" id="nage" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="drpNomineeRelation" class="col-sm-5 control-label">Nominee Relation</label>
                                <div class="col-sm-7">
                              ...
                              <div class="form-group row">
                                    <label for="txtAddress" class="col-sm-5 control-label">Address <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-7">
                             ...
                             <div class="form-group row">
                                    <label for="txtDistrict" class="col-sm-5 control-label">District <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-7">
                                        <input name="district" type="text" readonly="readonly" id="district" class="form-control" Placeholder="Enter District" />
                                        <span id="ContentPlaceHolder1_RequiredFieldValidator4" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Enter District</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="ddlBranch" class="col-sm-5 control-label">Branch Name <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group row">
                                    <label for="drpState" class="col-sm-5 control-label">State <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-7">
                                       
                                         <input name="state" type="text" readonly="readonly" id="state" class="form-control" />
                             ...
                             <div class="form-group row">
                                    <label for="txtPin" class="col-sm-5 control-label">Pin Code <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-7">
                                        <input name="pin" type="text" maxlength="6" readonly="readonly" id="pin" class="form-control" Placeholder="Enter Pincode" />
                                         <span id="ContentPlaceHolder1_RequiredFieldValidator5" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Enter PIN</span>
                                    </div>
                                </div>
                            <div class="form-group row">
                                <label for="ddlBranch" class="col-sm-5 control-label">Mode Of Operation <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                   <select name="modeOfOp" id="modeOfOp" class="form-control" style="width: 100%;">
	...
	<option value="Survivor">Survivor</option>
                            ...
                            <div class="form-group row">
                                <label for="txtJointMemberName" class="col-sm-5 control-label">Joint/Survivor Code</label>
                                <div class="col-sm-7">
                                    <input name="jointCode" type="text"  id="jointCode" class="form-control" />
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="txtJointMemberName" class="col-sm-5 control-label">Joint/Survivor Name</label>
                                <div class="col-sm-7">
                                      <input name="jointName" type="text" readonly="readonly" id="jointName" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="drpJointMembersRelativeRelation" class="col-sm-5 control-label">Relation</label>
                                <div class="col-sm-7">
                                     <select name="jointRelation" id="jointRelation" class="form-control" style="width: 100%;">
	<option value="">--Select--</option>
                            ...
                            <div class="form-group row">
                                <label for="txtSchemeName" class="col-sm-5 control-label">Select Plan <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                   <select name="sBPlan"  id="sBPlan" class="form-control" style="width: 100%;">
	...
	<option value="104">Royal SB Account</option>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 control-label">Opening Amount  <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="openingAmount" type="text" value="500" id="openingAmount" class="form-control"  />
                                    <span id="ContentPlaceHolder1_RequiredFieldValidatorOpeningAmount" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Enter Opening Amount</span>
                                </div>
                            </div>
                             <div class="form-group row">
                                <label class="col-sm-5 control-label">Advisor/Collector<strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="advisorCode" type="text"   id="advisorCode" class="form-control" placeholder="Enter Advisor/Collector Code" />
                                    <span id="ContentPlaceHolder1_RequiredFieldValidator1" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Enter Advisor/Collector Code</span>
                                </div>
                            </div>
                             <div class="form-group row">
                                <label class="col-sm-5 control-label">Name <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    ...
                                    <span id="ContentPlaceHolder1_RequiredFieldValidator2" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Enter Advisor/Collector Name</span>
                                </div>
                            </div>
                           <div class="form-group row">
                                    <label for="txtOpeningFees" class="col-sm-5 control-label">Opening Fees (if any)</label>
                                    <div class="col-sm-7">
                                       <input name="opFees" type="text" value="0" id="opFees" class="form-control" onkeypress="return isNumberOnlyKey(this, event);" />
                                    </div>
                                </div>
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Account Status <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                        <label class="switch">
                                       <input id="chkisactive" type="checkbox" name="chkisactive"  />
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <label class="switch">
                                       <input id="chkisSms" type="checkbox" value ="1" name="chkisSms"  />
                                        <span class="slider round"></span>
                                            </label>
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-sm-4 control-label">Debit Card Issue <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                        <label class="switch">
                                       <input id="chkdebitcard" type="checkbox"  name="chkdebitcard" />
                                        <span class="slider round"></span>
                                            </label>
                                    </div>
                                </div>
                     ...
                     <div class="box-footer">
                                <div class="row col-md-12">
                                    <input onclick="softdeleteintegrationforSavingRectificationDelete()" type="button" name="ctl00$ContentPlaceHolder1$btnDelete" value="Delete"  id="ContentPlaceHolder1_btnDelete" class="btn btn-danger pull-right" />
                                    <input  onclick="redirectThePageToNew()" type="button" name="ctl00$ContentPlaceHolder1$btnNew" value="New" id="ContentPlaceHolder1_btnNew" class="btn btn-info pull-right margin-r-5" />
                                    <input type="button" name="submitBtnUpdate" value="Update"  id="submitBtnUpdate" class="btn btn-success pull-right margin-r-5" />
                                </div>
                            </div>
                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="text-center">
                                    <img id="imageApplicant" class="profile-user-img"  style="width:110px;" />
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="text-center">
                                    <img id="imageSignature" class="profile-user-img"  style="height:70px;width:115px;" />
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="text-center">
                                    <img id="imgJointPhoto" class="profile-user-img"  style="width:110px;" />
                                     <input type="file"  name="thirdfiletag" id="thirdfiletag" />
                                </div>
                            </div>
                        </div>
    ...
    reserved.
      ...
      //Soft delete integration for Saving Rectification Delete
        ...
        var fileTag = document.getElementById("filetag"),
            imageApplicant = document.getElementById("imageApplicant"),
            secondfiletag = document.getElementById("secondfiletag"),
            imageSignature = document.getElementById("imageSignature");
