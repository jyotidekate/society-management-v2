...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true" onload="SavingsTransactionDelete();BranchName1();SharePayment();">
...
//]]>
	...
	<option value="001">Select Branch Name </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="accountNo"  id="accountNo" onchange="searchbyaccountno();"  class="form-control select2" style="width: 100%;">
	<option selected="selected" value="">Select Acc.No.</option>
                            ...
                            <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="accHolderName" type="text" readonly="readonly" id="accHolderName" class="form-control" Placeholder="Enter A/C Holder Name" />
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="mobileNumber" type="text" readonly="readonly" id="mobileNumber" class="form-control" Placeholder="Enter Mobile Number" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="jointHolder" type="text" readonly="readonly" id="jointHolder" class="form-control" Placeholder="Joint Holder Name" />
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="sbPlanName" type="text" readonly="readonly" id="sbPlanName" class="form-control" Placeholder="SB Plan Name" />
                        ...
                        <div class="box-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                         <input name="avaBalance" type="text" readonly="readonly" id="avaBalance" class="form-control" />
                                    </div>
                                </div>
                               <div class="form-group row">
                            ...
                            <div class="col-md-6">
                             <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="txnType" id="txnType" class="form-control select2" style="width: 100%;">
	...
	<option value="Withdrawal">Withdrawal</option>
                               ...
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                         <select name="paymentBy"  id="paymentBy" class="form-control select2" style="width: 100%;">
                            ...
                            <div class="box-footer">
                                <div class="row col-md-12">
                                    <input type="submit" name="ctl00$ContentPlaceHolder1$btnDelete" value="Delete" onclick="softDeleteSavingsTransaction();" id="ContentPlaceHolder1_btnDelete" class="btn btn-danger pull-right" />
