...
<body onload="getAllPolicyNumber1InTheDailyRenewalRectification()" class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
...
//]]>
                    ...
                    <div class="box-body">
                        <div class="col-md-4">
                            <div class="form-group row">
                                <label for="ddlPolicyNoName" class="col-sm-4 control-label">Policy No.<strong style="color: Red">*</strong></label>
                                 <div class="col-sm-8">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                <label class="col-sm-5 control-label">Renewal Date<strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <div class="input-group date">
                                        ...
                                        <input
                                          onchange="javascript:getByDateAddInvesmentCode()" 
                                          name="renewalDate"
                                          type="date" 
                                          id="renewalDate"
                                          class="form-control"
                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 control-label">Policy Date <strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input name="policyDate1" type="text" readonly="readonly" id="policyDate1" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                    </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 control-label">Maturity Date <strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input name="mDate" type="text" readonly="readonly" id="mDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                    </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <span id="ContentPlaceHolder1_RequiredFieldValidator2" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Member Code</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 control-label">Applicant Name<strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <input name="applicantName" type="text" readonly="readonly" id="applicantName" class="form-control" />
                                    <span id="ContentPlaceHolder1_RequiredFieldValidatorMembersRelativeRelationName" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Applicant Name</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtMembersMobileNo" class="col-sm-4 control-label">Mobile No<strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <input name="mobileNo" type="text" readonly="readonly" id="mobileNo" class="form-control" Placeholder="Enter Mobile No" />
                                    <span id="ContentPlaceHolder1_RequiredFieldValidatortxtMembersMobileNo" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Mobile No</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtPolicyAmount" class="col-sm-4 control-label">Policy Amount<strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <input name="PolicyAmount" type="text" readonly="readonly" id="PolicyAmount" class="form-control" Placeholder="Enter Policy Amount" style="color:Red;font-weight:bold;" />
                                    <span id="ContentPlaceHolder1_RequiredFieldValidatorPolicyAmount" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Policy Amount</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input name="schemeName" type="text" readonly="readonly" id="schemeName" class="form-control" Placeholder="Scheme Name" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtSchemeTerm" class="col-sm-4 control-label">Scheme Term<strong style="color: Red">*</strong></label>
                                <div class="col-sm-4">
                                    <input name="schemeType" type="text" readonly="readonly" id="schemeType" class="form-control" Placeholder="Enter Term" />

                                </div>
                                <div class="col-sm-4">
                                    <input name="mode" type="text" readonly="readonly" id="mode" class="form-control" Placeholder="Mode" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtMaturityAmount" class="col-sm-4 control-label">Maturity Amt.<strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <input name="maturityAmount" type="text" readonly="readonly" id="maturityAmount" class="form-control" Placeholder="Maturity Amount" style="color:Red;font-weight:bold;" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtTotalDepositedAmount" class="col-sm-4 control-label">Net Deposited<strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <input name="totalDeposit" type="text" readonly="readonly" id="totalDeposit" class="form-control" style="color:Red;font-weight:bold;" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtMaturityAmountDue" class="col-sm-4 control-label">Amount Due<strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <input name="MaturityAmountDue" type="text" readonly="readonly" id="MaturityAmountDue" class="form-control" style="color:Red;font-weight:bold;" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtSmsStatus" class="col-sm-4 control-label">SMS Status<strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <input name="chkisSms" type="text" readonly="readonly" id="chkisSms" class="form-control" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtSmsStatus" class="col-sm-4 control-label">Advisor Code<strong style="color: Red">*</strong></label>
                                <div class="col-sm-8">
                                    <input name="advisorCode" type="text" readonly="readonly" id="advisorCode" class="form-control" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-5 control-label">Last Inst. Paid <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="lastInstPaid" type="text" readonly="readonly" id="lastInstPaid" class="form-control" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5 control-label">Due Date <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input name="dueDate" type="text" readonly="readonly" id="dueDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                    </div>

                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5 control-label">Late Fine <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="latefine" type="text" value="0" readonly="readonly" id="latefine" class="form-control" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5 control-label">No. Installment Paid <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="NoOfInstPaid" type="text" id="NoOfInstPaid" class="form-control" placeholder="Enter No Of Inst. Paid" autocomplete="off" onpaste="return false" onkeypress="return isNumberOnlyKey(this, event);" style="color:Red;font-size:Large;font-weight:bold;" />
                                    <span id="ContentPlaceHolder1_RequiredFieldValidator1" style="color:Red;font-size:X-Small;font-weight:bold;display:none;">Enter No. Installment Paid</span>
                                </div>
                            </div>
                            <div class="form-group row">
	...
	<option value="SBAccount">SBAccount</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="collectorCode" type="text"  id="collectorCode" class="form-control" placeholder="Enter Advisor/Collector Code" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="advisorName" type="text" readonly="readonly" id="advisorName" class="form-control" placeholder="Advisor/Collector Name" />
                    ...
                    <div class="box-footer">
                        <div class="row col-md-12">
                            <div id="ContentPlaceHolder1_UpPopup">
                                    ...
                                    <input type="submit" name="ctl00$ContentPlaceHolder1$btnView" value="View Installment" id="ContentPlaceHolder1_btnView" class="btn btn-warning pull-left margin-r-5" data-target="#modal-warning" data-toggle="modal" />
                                
</div>
                            
                            <input type="submit" name="ctl00$ContentPlaceHolder1$btnDelete" value="Delete Last Entry" onclick="softDeleteIntegration()" id="ContentPlaceHolder1_btnDelete" class="btn btn-danger pull-right" />
