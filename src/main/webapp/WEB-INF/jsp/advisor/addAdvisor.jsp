...
<body class="skin-blue sidebar-mini"
	...
	cz-shortcut-listen="true" onload=" appendSelectMember(); RelativeRelationDropdown(); selectPosition(); branchNameList();">
	<!-- <form method="post" action="saveAdvisor" id="form1"
		modelAttribute="user"> -->
		<div class="aspNetHidden">
			<input type="hidden" name="_EVENTTARGET" id="_EVENTTARGET" value="" />
			<input type="hidden" name="_EVENTARGUMENT" id="_EVENTARGUMENT"
				value="" /> <input type="hidden" name="__LASTFOCUS"
				id="__LASTFOCUS" value="" /> <input type="hidden"
				name="_VIEWSTATE" id="_VIEWSTATE" value="" />
		</div>
		<div
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input name="relativeRelation" type="text"
													readonly="readonly" id="relativeRelation" placeholder="Enter Relative Relation"
													class="form-control" />
											</div>
										</div>
										<div class="form-group row">
									...
									<div class="col-md-6">
										...
										<div class="form-group row">
											<label for="txtNomineeName" class="col-sm-4 control-label">Nominee
												Age</label>
											<div class="col-sm-8">
												<input name="nomineeAge" type="text" maxlength="2" placeholder="Enter Nominee Age"
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input name="state" type="text" readonly="readonly"
													id="state" class="form-control" placeholder="Enter State" /> <span id="state"
													style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Select
													State</span>
											</div>
										</div>
									...
									<div class="col-md-6">
										...
										<div class="form-group row">
											<label class="col-sm-4 control-label">Position <strong
												style="color: Red">*</strong></label>
											<div class="col-sm-8">
												<input name="position" type="text" readonly="readonly" placeholder="Enter Position"
													id="position" class="form-control" /> <span id="position"
													style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Enter
									...
									<div class="col-md-6">
										...
										<div class="form-group row">
											<label class="col-sm-4 control-label">Fees (if any) <strong
												style="color: Red">*</strong></label>
											<div class="col-sm-8">
												<input name="feesIfAny" type="text" id="feesIfAny" placeholder="Enter Fees"
													class="form-control" /> <span id="feesIfAny"
													style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Enter
								...
								<div class="box-footer">
									<div class="row col-md-12">
										<input type="submit" name="ctl00$ContentPlaceHolder1$btnNew"
											value="New" id="ContentPlaceHolder1_btnNew" onclick="loadNewPage()"
