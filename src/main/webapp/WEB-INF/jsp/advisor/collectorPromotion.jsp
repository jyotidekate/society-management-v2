...
<body class="skin-blue sidebar-mini" onload="selectCodeOfAdvisor(); getBranchName()" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
...
<div class="aspNetHidden">
	...
	<input type="hidden" name="_VIEWSTATEGENERATOR" id="_VIEWSTATEGENERATOR" value="3A613B27" />
	<input type="hidden" name="_EVENTVALIDATION" id="_EVENTVALIDATION" value="" />
</div>
...
//]]>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="position1" type="text" readonly="readonly" id="position1" class="form-control" PlaceHolder="Enter Position" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="srPosition" type="text" readonly="readonly" id="srPosition" class="form-control" PlaceHolder="Enter Position" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="immidiateJr" type="text" readonly="readonly" id="immidiateJr" class="form-control" PlaceHolder="Enter Immidiate Junior" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="jrPosition" type="text" readonly="readonly" id="jrPosition" class="form-control" PlaceHolder="Enter Position" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="memberDataBranch2" id="memberDataBranch2" class="form-control" style="width: 100%;">
												<option value=""></option>
											</select>
	...
	<option value=""></option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="seniorPosition" type="text" readonly="readonly" id="seniorPosition" class="form-control" PlaceHolder="Enter New Senior Position" />
                        ...
                        <div class="box-footer">
                            <div class="row col-md-12">
                                ...
                                <input type="submit" name="ctl00$ContentPlaceHolder1$btnUpdate" value="Update" onclick="javascript:updateThroughSelectedCode()" id="ContentPlaceHolder1_btnUpdate" class="btn btn-success pull-right margin-r-5" />
                            </div>
                        </div>
                    </div>
                </div>
