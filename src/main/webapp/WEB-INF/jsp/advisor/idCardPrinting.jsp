...
<div class="aspNetHidden">
	...
	<input type="hidden" name="_VIEWSTATEGENERATOR" id="_VIEWSTATEGENERATOR" value="FF40372F" />
	<input type="hidden" name="_EVENTVALIDATION" id="_EVENTVALIDATION" value="/wEdAAUny6XaKZd7UOB/81iJEEqBXXhtDrRv6st/qI+x+N0hz4VNppXIEHMAIHNnY0nj1N3tvC+Dj7P0n1Q2fR8oG15qjkxbpcxoWPNP2dR2wiSei2ZlxxvU23W002vaN2Q2wqEI2NArEhABGkg7fgmHUl52" />
</div>
                            ...
                            <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <button id="ContentPlaceHolder1_btnSearch" 
                                    	class="btn btn-success margin-20" onclick="ShowDetailsIdCardAdvisor();">SEARCH</button>
                                </div>
                            </div>
