...
<!-- Dk/Admin/LoanPreSettlement.aspx?Type=Normal EDB D 09:27:10 GMT -->
<!-----DKB------>
...
<body onload="getListOfLoanId()" class="skin-blue sidebar-mini"
	...
	<form method="post" action="closeLoan" modelAttribute="closeLoan"
		id="form1">
		<%
									...
									<div class="box-body">
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<select name="id" id="searchLoanId"
								...
								<div class="box-body">
									<div class="col-md-4">
										...
										<div class="form-group row">
											...
											<div class="col-sm-7">
												<input name="codeName" type="text" readonly="readonly"
													id="codeName" class="form-control"
										...
										<div class="form-group row">
											<label for="txtNameRelation" class="col-sm-5 control-label">Relative
												Details </label>
											<div class="col-sm-7">
												<input name="nameRelation" type="text" readonly="readonly"
													id="nameRelation" class="form-control"
								...
								<div class="box-body">
									<div class="col-md-4">
										<div class="form-group row">
											...
											<div class="col-sm-7">
												<input name="payableInterest" type="text"
													readonly="readonly" id="payableInterest"
										...
										<div class="form-group row">
											<label for="txtTotalPayableAmt"
												...
												style="color: Red">*</strong></label>
											<div class="col-sm-7">
												<input name="payablePrincipal" type="text"
													readonly="readonly" id="payablePrincipal"
										...
										<div class="form-group row">
											...
											<div class="col-sm-7">
												<input name="payableAmount" type="text" readonly="readonly"
													id="payableAmount" class="form-control"
													PlaceHolder="Total Paid" onpaste="return false"
													onkeypress="return isNumberKey(this, event);"
													autocomplete="off" /> <span
										...
										<div class="form-group row">
											...
											<div class="col-sm-4">
												<select name="closingChrg" id="closingChrg"
											...
											<div class="col-sm-3">
												<input name="preClosingChages" type="text" value="0"
													readonly="readonly" id="preClosingChages"
													class="form-control" />
											</div>
										</div>
									</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-7">
													<input name="totalInterestDue" type="text"
														id="totalInterestDue" class="form-control"
										...
										<div class="form-group row">
											...
											<div class="col-sm-7">
												<div class="input-group date">
													...
													<input name="paymentDate" type="text" value="01/08/2022"
