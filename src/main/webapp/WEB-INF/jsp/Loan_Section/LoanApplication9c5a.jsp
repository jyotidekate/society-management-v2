											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<select name="searchLoanId"
														onchange="getByLoanId()" id="searchLoanId"
														class="form-control select2" style="width: 100%;">
														<% if(loanList!=null && !loanList.isEmpty()){
															for(Loan loan : loanList){
														%>
														<option selected="selected" value="<%=loan.getId()%>"><%=loan.getId() %></option>
														<%}} %>
													</select>
												</div>
											</div>
									...
									<div class="col-md-6">
										<div class="form-group row">
											<label for="txtProcessingFee" class="col-sm-4 control-label">Approval
												Status</label>
											<div class="col-sm-8">
												<input name="approvalStatus" type="text" readonly="readonly"
								...
								<div class="box-footer">
									<div class="row col-md-12">
										...
										<input type="submit" name="ctl00$ContentPlaceHolder1$btnNew"
											...
											onclick="this.disabled = true" /> <input type="submit"
