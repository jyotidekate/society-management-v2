								...
								<div class="box-footer">
									<div class="row col-md-12">
										<input type="submit" name="loanStatement"
											onclick="this.disabled = true" value="Loan Statement"
											id="loanStatement" class="btn btn-warning pull-left" /> <input
											type="submit" name="delete" onclick="this.disabled = true"
											value="Delete Last EMI" id="delete"
