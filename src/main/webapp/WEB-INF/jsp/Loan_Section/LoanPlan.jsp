								...
								<div class="box-body">
									<div class="col-md-4">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<select name="emiCollection" id="emiCollection"
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<select name="roiType" onchange="" id="roiType"
													class="form-control" style="width: 100%;">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<select name="emiType" id="emiType" disabled="disabled"
								...
								<div class="box-body">
									...
									<div>
										<table cellspacing="0" cellpadding="3" rules="all"
											...
											border="1" id="ContentPlaceHolder1_gdvDataLoan"
