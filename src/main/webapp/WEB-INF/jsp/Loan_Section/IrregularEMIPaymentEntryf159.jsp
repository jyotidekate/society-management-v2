							...
							<div class="box box-success">
								...
								<div class="box-body">
									...
									<div class="col-md-4">
										...
										<div class="form-group row">
											<label for="txtTotalInterest" class="col-sm-5 control-label">Interest
										...
										<div class="form-group row">
											<label for="txtTotalPrinciple" class="col-sm-5 control-label">Principal
												Paid<strong style="color: Red">*</strong>
											</label>
											<div class="col-sm-7">
										...
										<div class="form-group row">
											...
											<div class="col-sm-7">
												<input name="totalPaid" type="text" readonly="readonly"
							...
							<div class="box box-danger">
								...
								<div class="box-body">
									<div class="col-md-4">
										...
										<div class="form-group row">
											<label for="txtAdvancePaid" class="col-sm-5 control-label">Runing
									...
									<div class="col-md-4">
										<div class="form-group row">
											<label for="ddlDeductLateFine" class="col-sm-5 control-label">Deduct
										...
										<div id="ContentPlaceHolder1_uppnlcal">
											...
											<div class="form-group row">
												...
												<div class="col-sm-7">
													<input name="payableInterest" type="text"
														...
														class="form-control" PlaceHolder="Payable Interest" /> <span
											...
											<div class="form-group row">
												<label for="txtTotalPayableAmt"
													class="col-sm-5 control-label">Payable Principal</label>
												<div class="col-sm-7">
													<input name="payablePrincipal" type="text"
														readonly="readonly" id="payablePrincipal"
														class="form-control" PlaceHolder="Payable Principal" /> <span
										...
										<div class="form-group row">
											...
											<div class="col-sm-7">
												<div class="input-group date">
													...
													<input name="payablePrincipalaymentDate" type="text"
														value="01/08/2022" id="payablePrincipalaymentDate"
														class="form-control"
														data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;"
														data-mask="" />
												</div>
