                     ...
                     <div class="box box-success">
                        ...
                        <div id="ContentPlaceHolder1_pnlCdetails" class="aspNetDisabled">
                           <div class="box-body">
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                       ...
                                       <input name="doj" type="date"  disabled="disabled" 
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    <label>TAX Deduction(Seniour) :</label>
                              ...
                              <button type="submit" class="btn btn-info pull-right margin-r-5" id="updateBtn" disabled>Update</button>
                           	  </div>
                           </div>
                        </div>
                     </div>
                           ...
                           <div class="col-md-3">
                              <div class="form-group">
                                 <div class="text-center">
                                   <img id="preview" class="profile-user-img" src="upload_Files/${Logo}"  alt="Image" style="height:110px;width:110px;">  
                     ...
                     <div class="box box-success">
                        ...
                        <div class="box-body">
                           <div class="col-md-3">
                              <div class="form-group">
                                 <div class="text-center">
                                     <img id="secondpreview" class="profile-user-img" src="upload_Files/${Signature}"  alt="Image" style="height:110px;width:110px;">
