...
<body  onload="getAllDirectorMaster();setBranchInSelectOption();fetchDepositeAccount()" class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
                     ...
                     <div class="box-body">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                 <div class="input-group date">
                                    ...
                                    <input name="dateOfBirth" type="date"  id="dateOfBirth" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                 <div class="input-group date">
                                    ...
                                    <input name="appointmentDate" type="date"  id="appointmentDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                        ...
                        <div class="col-md-5">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                 <input name="shareNominalValue" type="text" oninput="calculate()" Placeholder="Enter Face Value" id="shareNominalValue" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group row">
                              <label for="txtShareAmount" class="col-sm-4 control-label">Share Amount <strong style="color: Red">*</strong></label>
                              <div class="col-sm-8">
                                 <input name="shareAmount" type="text" id="shareAmount" onkeyup="calculate()" class="form-control" Placeholder="Enter Share Amount" />
                        ...
                        <div class="col-md-2">
                           <div class="row">
                              <div class="col-sm-12">
                                 <img id="preview" src="data:image/png;base64,${directorLogo}" style="height:110px;width:110px;" />
                                 <input type="file" onchange="uploadFile('logo','Director')" name="filetag" id="filetag" />
                              </div>
                           </div>
                           <div class="row margin">
                              <div class="col-sm-12">
                                 <img id="secondpreview" src="data:image/png;base64,${directorSignature}" style="height:70px;width:115px;" />
                                 <input type="file"  onchange="uploadFile('signature','Director')" name="secondfiletag" id="secondfiletag" /> 
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="col-md-12">
                  <div class="box box-info">
                     ...
                     <div class="box-body">
                        <div class="col-md-6">
                           <div class="form-group row">
                              <label class="col-sm-4 control-label">Payment By<strong style="color: Red">*</strong></label>
                              <div class="col-sm-8">
                                 <select  onchange="callthedepostnumber(this.value);" name="paymode"  id="paymode" class="form-control" style="width: 100%;">
                              ...
                              <div class="form-group row">
                                 <label for="txtChequeNo" class="col-sm-4 control-label">Cheque NO</label>
                                 <div class="col-sm-8">
                                    <input name="chequeNO" type="text" id="chequeNO"  class="form-control" Placeholder="Enter Cheque No" />
                                 </div>
                              </div>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <div class="input-group date">
                                       ...
                                       <input name="chequeDate" type="date"  id="chequeDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                    </div>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <select name="deposistAC"  id="deposistAC" class="form-control" style="width: 100%;">
                                    </select>
                                 </div>
                              </div>
                           </div>
