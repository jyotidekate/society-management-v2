...
<!--                                     <input name="" type="text"  id="" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" /> -->
                                    <input name="fDate" type="date" value="01/08/2022"  id="fDate" class="form-control" data-inputmask="" data-mask="" />
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-3">
                              <div class="form-group">
                                 ...
                                 <div class="input-group date">
                                    <div class="input-group-addon">
                                      ...
                                      <input name="tDate" type="date" value="01/08/2022"  id="tDate" class="form-control" data-inputmask="" data-mask="" />
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-2">
