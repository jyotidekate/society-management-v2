...
<body onload="getCategoryDetails()" class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
   <form method="post" action="SaveCategory" modelAttribute="CategoryModel" name="CategoryModel" id="form1">
