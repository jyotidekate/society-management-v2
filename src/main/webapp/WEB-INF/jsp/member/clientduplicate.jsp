...
<body   class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" onload="fetchTheData()" cz-shortcut-listen="true">
                        ...
                        <div class="box-body">
                           ...
                           <div class="col-md-6">
                              <div class="form-group row">
                                 <label class="col-sm-4 control-label">Client ID <strong style="color: Red">*</strong></label>
                                 <div class="col-sm-8">
<!--                                  	<input name="id" type="text" maxlength="10" id="id" class="form-control" onkeyup="FetchDetailByMemberIdforcleintDeduplication();" placeholder="Enter Client ID" autocomplete="off" /> -->
                                 	    <select onchange="window.location.href=this.value;" name="clientID" id="clientID" onchange="" class="form-control" style="width: 100%;">
                               ...
                               <option value="getDataOfShare?ID=${option.id}">${option.id}--${option.memberName}</option>
                                    ...
                                    <span id="branchCodeMsg" style="color:Red;font-size:X-Small;font-weight:bold;display:none;"></span>
                                 </div>
                              </div>
                           </div>
                              ...
                              border="1"  style="width:100%;border-collapse:collapse;">
                                 <caption>
                                  ...
                                  <tr  >
                                    ...
                                    <td><input type="text" id="input1"  value ="${data123.id }" style="font-weight: bold;"></td>
                                     <td><input type="text" id="input2"  value ="Share Transfer" style="font-weight: bold;"></td>
                                      <td><input type="text" id="input3" value ="${data123.noOfShare}" style="font-weight: bold;"></td>
                                    ...
                                    <td><input type="text" id="input11"  value ="${dat.id}" style="font-weight: bold;"></td>
                                     <td><input type="text" id="input12"  value ="Loan" style="font-weight: bold;"></td>
                                   <td><input type="text" id="input13" value ="${dat.loanAmount}" style="font-weight: bold;"></td>
...
<!--                                  	<input name="id2" type="text" maxlength="10" id="id2" class="form-control" placeholder="Enter Branch Code" onkeyup="FetchDetailByMemberIdforcleintDeduplication2();" autocomplete="off" /> -->
                                   <select name="id2" id="id2" onchange="FetchDetailByMemberIdforcleintDeduplication2();" class="form-control" style="width: 100%;">
                                          <option value="" >Select</option>                                         
                                       </select>
                           ...
                           <div class="col-md-6">
                              <div class="form-group row">
                                 <label for="txtPin" class="col-sm-4 control-label">Client Name <strong style="color: Red">*</strong></label>
                                 <div class="col-sm-8">
                                    <input name="memberName2" type="text" maxlength="7" id="memberName2" class="form-control"  />
                        ...
                        <div class="box-body">
                           ...
                           <div>   
                              ...
                              border="1"  style="width:100%;border-collapse:collapse;">
                                ...
                                <tr>
                                <td><input type="text" name="table2input1" id="table2input1" style="font-weight: bold;"></td>
                                <td><input type="text" name="table2input2" id="table2input2"  style="font-weight: bold;"></td>
                                <td><input type="text" name="table2input3" id="table2input3"  style="font-weight: bold;"></td>
                                </tr>
                                
                                
                                 <tr>
                                <td><input type="text" name="table2input11" id="table2input11" style="font-weight: bold;"></td>
                                <td><input type="text" name="table2input12" id="table2input12"  style="font-weight: bold;"></td>
                                <td><input type="text" name="table2input13" id="table2input13"  style="font-weight: bold;"></td>
                                </tr>
                               ...
                               id="savebtn" class="btn btn-success pull-right margin-r-5">Save</button>
                              </section>
