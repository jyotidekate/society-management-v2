...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; 
   background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true" 
                           ...
                           <div class="box-body">
                              <div class="col-md-6">
                               ...
                               <div id="ContentPlaceHolder1_idverify" class="form-group row">
                                    <label class="col-sm-4 control-label" style="color: green;">Client NO<strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                    
                                       <input name="clientNo" " type="text" maxlength="6" id="clientNo" class="form-control" readonly="readonly" />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <div class="input-group date">
                                          ...
                                          <input" name="registrationDate" type="date" id="registrationDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                       </div>
                                 ...
                                 <div class="form-group row">
                                    <label class="col-sm-4 control-label">Client Name <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-3">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                       <div class="input-group date">
                                          ...
                                          <input name="dob" type="date" onchange="calculateAge()" onkeypress="" id="dob" class="form-control" data-inputmask="" data-mask="" />
                                       </div>
                                    </div>
                                    <div class="col-sm-3">
                                       <input  name="age" type="text"  maxlength="2" id="ageId" class="form-control" Placeholder="Enter Age" onkeypress="" autocomplete="off" />
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <textarea  name="address"  id="ContentPlaceHolder1_txtAddress" class="form-control" Placeholder="Enter Addess">
                                       </textarea>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <select value="" name="state" id="state" class="form-control select2" style="width: 100%;">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <select name="branchName" id="branchName1" class="form-control select2" style="width: 100%;">
                                  ...
                                  <h3 style="font-weight: bold;">Internet Banking </h3>
                                   ...
                                   <div class="form-group row">
                                    <label for="txtPin" class="col-sm-4 control-label">Login ID <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                       <input name="loginID" type="text" maxlength="6" id="loginID" class="form-control" Placeholder="Enter Login ID" />
                                        </div>
                                 </div>
                                 
                                 <div class="form-group row">
                                    <label for="txtPin" class="col-sm-4 control-label">Password <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                  ...
                                  <div class="form-group row">
                                    <label for="txtPin" class="col-sm-4 control-label">Member Income  <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                       <input name="memberIncome" type="text"  id="memberIncome" class="form-control" Placeholder="Enter Member Income" />
                                        </div>
                                 </div>
                             </div>
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                       <input type="submit" name="ctl00$ContentPlaceHolder1$btnPANverify" value="Verify" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$ContentPlaceHolder1$btnPANverify&quot;, &quot;&quot;, true, &quot;P&quot;, &quot;&quot;, false, false))" id="ContentPlaceHolder1_btnPANverify" class="btn btn-danger verify pull-right" disabled/>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                       <input type="submit" name="ctl00$ContentPlaceHolder1$btnvoterverify" value="Verify" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$ContentPlaceHolder1$btnvoterverify&quot;, &quot;&quot;, true, &quot;K&quot;, &quot;&quot;, false, false))" id="ContentPlaceHolder1_btnvoterverify" class="btn btn-danger verify pull-right" disabled />
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label for="txtIntroMCode" class="col-sm-4 control-label">Client Purpose<strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                       <input name="clientPurpose" id="clientPurpose" type="text"   class="form-control" Placeholder="Enter Client Purpose" />
                                   	   <span id="message"></span>
                                    </div>
                                 </div>
                                 
                                  <div class="form-group row">
                                    <label for="txtIntroMCode" class="col-sm-4 control-label">Passport Number<strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                       <input name="passportNumber" id="passportNumber" type="text"   class="form-control" Placeholder="Enter Passport Number" />
                                   	   <span id="message"></span>
                                    </div>
                                 </div>
                                
                                  <div class="form-group row">
                                    <label class="col-sm-4 control-label">Caste Name <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                       <select name="casteName" id="casteName" class="form-control select2" style="width: 100%;">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-sm-4 control-label">Religion Name <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                       <select name="religionName" id="religionName" class="form-control select2" style="width: 100%;">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-sm-4 control-label">Category Name <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                       <select name="categoryName" id="categoryName" class="form-control select2" style="width: 100%;">
                                   ...
                                   <div class="form-group row">
                                    <label class="col-sm-4 control-label">Risk Category <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                       <select name="riskCategory" id="riskCategory" class="form-control select2" style="width: 100%;">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-sm-4 control-label">Nationality <strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       src="data:image/png;base64,${aadharPhoto}" style="width:110px;" />
...
<!--                                     onchange="uploadFile('aadharPhoto','addMember')"  -->
            ...
            <div class="col-sm-8">
            <input name="nomineeAddress" type="text" id="ContentPlaceHolder1_txtNomineeAddress" class="form-control" Placeholder="Enter Nominee Address" />
            </div>
            </div>
            <div class="form-group row">
            <label for="txtNomineeKycNumber" class="col-sm-4 control-label">Nominee KYC No.</label>
            <div class="col-sm-8">
            <input name="nomineeKycNumber" type="text" id="ContentPlaceHolder1_txtNomineeKycNumber" class="form-control" Placeholder="Enter Nominee KYC No."/>
            </div>
            </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-sm-8">
            <input name="nomineeMobileNo" type="text" maxlength="10" id="ContentPlaceHolder1_txtNomineeMobileNo" class="form-control" Placeholder="Enter Nominee Mobile No."/>
            </div>
            </div>
            <div class="form-group row">
            <label for="txtNomineeAge" class="col-sm-4 control-label">Nominee Age.</label>
            <div class="col-sm-8">
            <input name="nomineeAge" type="text" maxlength="2" id="ContentPlaceHolder1_txtNomineeAge" class="form-control" Placeholder="Enter Nominee Age"/>
            </div>
            </div>
            <div class="form-group row">
            <label for="TxtNomineePanNo" class="col-sm-4 control-label">Nominee Pan No.</label>
            <div class="col-sm-8">
            <input name="nomineePanNo" type="text" maxlength="10" id="ContentPlaceHolder1_TxtNomineePanNo" class="form-control" Placeholder="Enter Nominee Pan No." />
            </div>
            </div>
            <div class="form-group row">
            ...
            <div class="col-md-6">
            <div class="form-group row">
            <label for="txtMemberJoiningFess" class="col-sm-4 control-label">Client Fees (if any) <strong style="color: Red">*</strong></label>
            <div class="col-sm-8">
            <input name="memberJoiningFess" type="text" id="ContentPlaceHolder1_txtMemberJoiningFess" class="form-control" placeholder="Enter Member Fees" />
            ...
            <div class="col-sm-8">
            <select name="shareAllotedfrm" id="shareAllotedfrm1" class="form-control select2" style="width: 100%;">
            ...
            <div class="col-sm-8">
            <input name="noOfShared" type="text" onchange="" id="ContentPlaceHolder1_txtNoOfShared" class="form-control" placeholder="Enter No. of Share" />
            ...
            <div class="col-sm-8">
            <input name="enterShareAmount" type="text" id="ContentPlaceHolder1_txtEnterShareAmount" class="form-control" placeholder="Enter Share Amount" />
            ...
            <div class="col-sm-8">
            <label class="switch">
            <input id="ContentPlaceHolder1_chkisactive" type="checkbox" name="memberStatusIsActive"  />
            ...
            <div class="col-sm-8">
            <label class="switch">
            <input id="ContentPlaceHolder1_chkisSms" type="checkbox" name="chkisSms"  />
            <span class="slider round"></span>
            </label>
            </div>
            </div>
            ...
            <input type="submit" name="ctl00$ContentPlaceHolder1$btnPrint" value="Print" id="ContentPlaceHolder1_btnPrint" class="btn btn-info pull-right margin-r-5" onclick="printTable()" />
            <input type="button" name="ctl00$ContentPlaceHolder1$btnSave" value="Save" onclick="" id="ContentPlaceHolder1_btnSave" class="btn btn-success pull-right margin-r-5" />
            </div>
            </div>
            </form>
