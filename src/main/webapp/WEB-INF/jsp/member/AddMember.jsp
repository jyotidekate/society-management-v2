                           ...
                           <div class="box-body">
                              <div class="col-md-6">
                               ...
                               <div id="ContentPlaceHolder1_idverify" class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <input name="clientNo" value="${count }" type="text" maxlength="6" id="clientNo" class="form-control" readonly="readonly" />
                                   
                                    </div>
                                 </div>
                                 
                                 <div id="ContentPlaceHolder1_idverify" class="form-group row">
                                    <label class="col-sm-4 control-label" style="color: green;">CLient ID<strong style="color: Red">*</strong></label>
                                    <div class="col-sm-8">
                                       <input name="clientIDNo" type="text" maxlength="6" id="clientIDNo" class="form-control" readonly="readonly" />
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <select name="branchName" id="branchName1" class="form-control" style="width: 100%;">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <select name="caste" id="caste" class="form-control" style="width: 100%;">
...
<!--                                            <option value ="A" >A </option> -->
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <select name="religionName" id="religionName" class="form-control" style="width: 100%;">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <select name="categoryName" id="categoryName" class="form-control" style="width: 100%;">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <select name="riskCategory" id="riskCategory" class="form-control" style="width: 100%;">
...
<!--                                     onchange="uploadFile('aadharPhoto','addMember')"  -->
            ...
            <div class="col-sm-8">
            <input name="nomineeAddress" type="text" id="nomineeAddress" class="form-control" Placeholder="Enter Nominee Address" />
            </div>
            </div>
            <div class="form-group row">
            <label for="txtNomineeKycNumber" class="col-sm-4 control-label">Nominee KYC No.</label>
            <div class="col-sm-8">
            <input name="nomineeKycNumber" type="text" id="nomineeKycNumber" class="form-control" Placeholder="Enter Nominee KYC No."/>
            </div>
            </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-sm-8">
            <input name="nomineeMobileNo" type="text" maxlength="10" id="nomineeMobileNo" class="form-control" Placeholder="Enter Nominee Mobile No."/>
            </div>
            </div>
            <div class="form-group row">
            ...
            <div class="col-sm-8">
            <input name="nomineePanNo" type="text" maxlength="10" id="nomineePanNo" class="form-control" Placeholder="Enter Nominee Pan No." />
            </div>
            </div>
            <div class="form-group row">
            ...
            <div class="col-sm-8">
            <input name="memberJoiningFess" type="text" id="memberJoiningFess" class="form-control" placeholder="Enter Member Fees" />
            ...
            <div class="col-sm-8">
            <input name="noOfShared" type="text" onchange="" id="noOfShared" class="form-control" placeholder="Enter No. of Share" />
            ...
            <div class="col-sm-8">
            <input name="enterShareAmount" type="text" id="enterShareAmount" class="form-control" placeholder="Enter Share Amount" />
            ...
            <input type="button" name="ctl00$ContentPlaceHolder1$btnUpdate" value="Update" onclick="" id="ContentPlaceHolder1_btnUpdate" class="btn btn-warning pull-right margin-r-5" />
            </div>
            </div>
            </form>
