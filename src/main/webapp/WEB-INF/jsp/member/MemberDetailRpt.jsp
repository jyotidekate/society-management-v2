...
<body class="skin-blue sidebar-mini" onload="reportDataFetchinDropDown();" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
      ...
      <div class="aspNetHidden">
         <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="74B5D76D" />
         <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAiOcw2a2ky4SNNJMbB4yAJWXXhtDrRv6st/qI+x+N0hz4VNppXIEHMAIHNnY0nj1N1BW5v+dQD/zYzH23/hOws57Nf2nFrT/teCXxgcaX2ByUPQI1RC2v7K0iVkfbE9+2rNLwNnpX7SaGgjTqu3VexijkxbpcxoWPNP2dR2wiSei+cFQykTAwaD9u4qdK4NqY7lFhA30D2CsiJLUA5ROsTg" />
      </div>
                     ...
                     <div class="box box-success">
                        ...
                        <div class="box-body">
                           ...
                           <div class="col-md-3">
                              <div class="form-group">
                                 <label></label>
                                 <button id="ContentPlaceHolder1_btnSearch" class="btn btn-success margin-20" onclick="getMemberRepottSearch();"><span class="fa fa-search" ></span> SEARCH</button>
                              </div>
                           </div>
