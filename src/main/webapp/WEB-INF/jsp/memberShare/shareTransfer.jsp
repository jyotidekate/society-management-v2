...
<body class="skin-blue sidebar-mini"
	...
	cz-shortcut-listen="true" onload="getShareTableData(); getTheValueInsahreTransferInTheDropDown();">
								...
								<div class="box-body">
									<div class="col-md-6">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<div class="input-group date">
													...
													<input name="doj" type="date" readonly="readonly" id="registrationDate"
														class="form-control"
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input id="previousNoOfShared" name="previousNoOfShared" type="text"
													 id="previousShareNo"
													class="form-control"
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input name="faceValue" type="text" value="10"
													disabled id="faceValue" class="form-control"
									...
									<div class="col-md-6">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input name="sharebalance" type="text" 
													disabled id="sharebalance" class="form-control"
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input name="transferAmount" type="text"
													...
													Placeholder="Enter Transfer Amount" required/> <span
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input name="noOfShared" type="text" disabled placeholder="Enter No. Of Share"
													id="noOfShared" class="form-control" required/> <span
