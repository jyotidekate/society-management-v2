...
<body class="skin-blue sidebar-mini"  onload="dropDownBranchCode();" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
                             ...
                             <div class="col-md-3">
                                <div class="form-group">
                                    <label></label>
                                         ...
                                         onclick="getMemberShareSearch();"><span class="fa fa-search"></span> SEARCH</button>
                                    </div>
                              ...
                              border="1"  style="width:100%;border-collapse:collapse;">
                                 ...
                                 <tr style="color:White;background-color:#008385;">
                                   <th scope="col">SL NO</th>
                                    ...
                                    <th scope="col">DNO FRM &TO</th>
                                    <th scope="col">BALANCE</th>
                                    <td scope="col">ISSUE FROM</td>
                        			<td scope="col">PAY MODE</td>
                        			<td scope="col">TXN ID</td>
                                  </tr> 
                                  <tbody id="tableBody">
