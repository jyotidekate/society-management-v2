...
<body onload="getAllDepartment()" class="skin-blue sidebar-mini"
	style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);"
	cz-shortcut-listen="true">
	<form method="post" action="saveDepartmentMasterData"
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input name="department" type="text" id="department"
													class="form-control" /> <span id="departmentMsg"
								...
								<div class="box-footer">
									<div class="row col-md-12">
										...
										<button type="button" name="save" value="Save"
											onclick="return validateDepartmentMaster()" id="save"
