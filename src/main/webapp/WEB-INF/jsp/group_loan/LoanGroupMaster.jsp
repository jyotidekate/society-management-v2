							...
							<div id="ContentPlaceHolder1_UpdatePanel1">
								<div class="box box-success">
									...
									<div class="box-body">
										<div class="col-md-12">
											<div class="form-group row">
												<label class="col-sm-5 control-label">Search By
											...
											<div class="form-group row">
												<label class="col-sm-5 control-label">Member Name <strong
													style="color: Red">*</strong>
												</label>
												<div class="col-sm-7">
											...
											<div class="form-group row">
												...
												<div class="col-sm-7">
													<input name="relative" type="text" readonly="readonly"
														id="relative" class="form-control" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-5 control-label">Mobile <strong
													style="color: Red">*</strong>
												</label>
												<div class="col-sm-7">
													<input name="mob" type="text" readonly="readonly" id="mob"
														class="form-control" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-5 control-label">Previous Loan
													<strong style="color: Red">*</strong>
												</label>
												<div class="col-sm-7">
													<input name="previousLoan" type="text" readonly="readonly"
														id="previousLoan" class="form-control" />
												</div>
											</div>
										</div>
									</div>
									<div class="box-footer">
										<div class="row col-md-12">
											<button type="button" name="ctl00$ContentPlaceHolder1$btnAdd"
												value="Add to Queue" id="ContentPlaceHolder1_btnAdd"
												class="btn btn-warning pull-right">Add to Queue</button>
										</div>
									</div>
								</div>
								<div class="box box-success"
									...
									<div class="col-md-3">
										<div class="form-group">
											<div class="text-center">
												<img id="ContentPlaceHolder1_imgGroupPhoto"
										...
										<div class="form-group">
											<div class="text-center">
												<input type="file"
													name="ctl00$ContentPlaceHolder1$fileGroupPhoto"
													id="ContentPlaceHolder1_fileGroupPhoto" accept="camera" />
							...
							<div class="box box-success">
								...
								<div class="box-body">
									<div class="col-md-3">
										<div class="form-group">
											<div class="text-center">
												<img id="ContentPlaceHolder1_ImageLeader"
													class="profile-user-img" src="dist/img/photo.jpg"
													style="width: 110px;" />
											</div>
										</div>
										<div class="form-group">
											<div class="text-center">
												<input type="file"
													name="ctl00$ContentPlaceHolder1$fileLeader"
													id="ContentPlaceHolder1_fileLeader" accept="camera" />
												<script type="text/javascript">
