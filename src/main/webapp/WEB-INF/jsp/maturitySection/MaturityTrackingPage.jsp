...
<!--     <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/MaturityTracking.aspx?Code=PR" id="form1"> -->
...
<!--                                  <a id="ContentPlaceHolder1_btnSearch" class="btn btn-success margin-20" href="javascript:__doPostBack(&#39;ctl00$ContentPlaceHolder1$btnSearch&#39;,&#39;&#39;)"><span class="fa fa-search"></span> SEARCH</a> -->
                                 <button type="submit"  onclick="getmaturityPayment();" class="btn btn-success pull-right margin-20" >Search</button>
                            </div>
                        ...
                        <div class="box-tools pull-right">                           
                         ...
                         <table cellspacing="0" cellpadding="3" rules="all" 
                              ...
                              border="1"  style="width:100%;border-collapse:collapse;">
                               <h3 style="text-align: center;"><b>Matuity Payment Report  </b></h3>
                                 <hr>
    ...
    reserved.
        ...
        <script src="dist/js/MaturityPaymentReportjs.js"></script>
<!--     </form> -->
</body>

<!-- Dk/Admin/MaturityTracking.aspx?Code=PR EDB D 09:27:20 GMT -->
</html>
