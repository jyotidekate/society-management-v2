...
<body class="skin-blue sidebar-mini"
	...
	<form method="post"
		action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/SavingsTransactionEntry.aspx"
								...
								<div class="box-body">
									<div class="col-md-6">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<select name="ctl00$ContentPlaceHolder1$ddlBranchName"
													id="ContentPlaceHolder1_ddlBranchName"
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<select name="ctl00$ContentPlaceHolder1$ddlSelectAccountNo"
													onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$ContentPlaceHolder1$ddlSelectAccountNo\&#39;,\&#39;\&#39;)&#39;, 0)"
													id="ContentPlaceHolder1_ddlSelectAccountNo"
													class="form-control select2" style="width: 100%;">
									...
									<div class="col-md-3">
										<div class="form-group">
											<div class="text-center">
												<a class="imgApp" href='dist/img/photo.jpg'
													data-lightbox="example-set"> <img
													id="ContentPlaceHolder1_ImageApplicant"
							...
							<div class="box box-success">
								...
								<div class="box-body">
									<div class="col-md-3">
										<div class="form-group">
											<div class="text-center">
												<a class="imgSig" href='dist/img/sign.jpg'
													data-lightbox="example-set"> <img
													id="ContentPlaceHolder1_ImageSignature"
													class="profile-user-img" src="dist/img/sign.jpg"
													style="height: 70px; width: 115px;" /></a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="box box-success">
								...
								<div class="box-body">
									<div class="col-md-3">
										<div class="form-group">
											<div class="text-center">
												<a class="imgJoint" href='dist/img/photo.jpg'
													data-lightbox="example-set"> <img
													id="ContentPlaceHolder1_imgJointPhoto"
													class="profile-user-img" src="dist/img/photo.jpg"
													style="width: 110px;" /></a>
											</div>
										</div>
