...
<body class="skin-blue sidebar-mini"
	...
	<form method="post"
		action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/SavingsPlanMaster.aspx"
									...
									<div class="box-body">
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtSchemeName"
														type="text" id="ContentPlaceHolder1_txtSchemeName"
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input
														name="ctl00$ContentPlaceHolder1$txtAnnualInterestRate"
														type="text" id="ContentPlaceHolder1_txtAnnualInterestRate"
											...
											<div class="form-group row">
												<label for="txtMinOpeningAmount"
													...
													style="color: Red">*</strong></label>
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtMinOpeningAmount"
														type="text" id="ContentPlaceHolder1_txtMinOpeningAmount"
														class="form-control"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input
														name="ctl00$ContentPlaceHolder1$txtMinMonthlyAvgBalance"
														type="text"
														id="ContentPlaceHolder1_txtMinMonthlyAvgBalance"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtLockInBalance"
														type="text" id="ContentPlaceHolder1_txtLockInBalance"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input
														name="ctl00$ContentPlaceHolder1$txtSmsChargesQarterly"
														type="text" id="ContentPlaceHolder1_txtSmsChargesQarterly"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<select
														name="ctl00$ContentPlaceHolder1$ddlInterestCreditTime"
														id="ContentPlaceHolder1_ddlInterestCreditTime"
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input
														name="ctl00$ContentPlaceHolder1$txtFreeIFSCCollection"
														type="text" id="ContentPlaceHolder1_txtFreeIFSCCollection"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtFreeTransfer"
														type="text" id="ContentPlaceHolder1_txtFreeTransfer"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
										...
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtSingleTxnLimit"
														type="text" id="ContentPlaceHolder1_txtSingleTxnLimit"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtDailyMaxlimit"
														type="text" id="ContentPlaceHolder1_txtDailyMaxlimit"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtWeeklyMaxLimit"
														type="text" id="ContentPlaceHolder1_txtWeeklyMaxLimit"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtMonthlyMaxLimit"
														type="text" id="ContentPlaceHolder1_txtMonthlyMaxLimit"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtServiceChrg"
														type="text" id="ContentPlaceHolder1_txtServiceChrg"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<select name="ctl00$ContentPlaceHolder1$ddlService"
														id="ContentPlaceHolder1_ddlService" class="form-control"
														style="width: 100%;">
														<option value="Monthly">Monthly</option>
														<option value="Quarterly">Quarterly</option>
														<option value="Half Yearly">Half Yearly</option>
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtCardCharge"
														type="text" id="ContentPlaceHolder1_txtCardCharge"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												<label for="txtCardLimitMonthly"
													...
													style="color: Red">*</strong></label>
												<div class="col-sm-8">
													<input name="ctl00$ContentPlaceHolder1$txtCardLimitMonthly"
														type="text" id="ContentPlaceHolder1_txtCardLimitMonthly"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input
														name="ctl00$ContentPlaceHolder1$txtCardTotalLimitYearly"
														type="text"
														id="ContentPlaceHolder1_txtCardTotalLimitYearly"
														class="form-control" onpaste="return false"
														onkeypress="return isNumberOnlyKey(this, event);" /> <span
									...
									<div class="box-body">
										<div>
											<table cellspacing="0" rules="all"
												...
												border="1" id="ContentPlaceHolder1_grSchemeList"
												...
												<tr style="color: White; background-color: #008385;">
													...
													<th scope="col">Avg Balance</th>
													<th scope="col">LockIn Balance</th>
													<th scope="col">SMS Mode</th>
													<th scope="col">Sms Charges</th>
													<th scope="col">Card Charges</th>
													<th scope="col">Card Limit Mly.</th>
													<th scope="col">Card Total Limit Yly.</th>
													<th scope="col">Action</th>
													<th scope="col">View</th>
												</tr>
												<tr>
													<td>100</td>
													<td>Basic SB Account</td>
													<td>0</td>
													<td>500</td>
													<td>500</td>
													<td>500</td>
													...
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl02$imgRDDelete"
														id="ContentPlaceHolder1_grSchemeList_imgRDDelete_0"
														src="../images/DeleteRed.png"
														style="height: 20px; width: 20px;" /></td>
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl02$imgBtnSelect"
														id="ContentPlaceHolder1_grSchemeList_imgBtnSelect_0"
														src="dist/img/view-icon.png"
														style="height: 20px; width: 20px;" /></td>
												</tr>
												<tr style="color: #000333; background-color: #F3ACAF;">
													<td>101</td>
													<td>Standard SB Account</td>
													<td>2</td>
													<td>1000</td>
													<td>750</td>
													<td>750</td>
													...
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl03$imgRDDelete"
														id="ContentPlaceHolder1_grSchemeList_imgRDDelete_1"
														src="../images/DeleteRed.png"
														style="height: 20px; width: 20px;" /></td>
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl03$imgBtnSelect"
														id="ContentPlaceHolder1_grSchemeList_imgBtnSelect_1"
														src="dist/img/view-icon.png"
														style="height: 20px; width: 20px;" /></td>
												</tr>
												<tr>
													<td>102</td>
													<td>Advantage SB Account</td>
													<td>3</td>
													<td>2500</td>
													<td>2000</td>
													<td>1000</td>
													...
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl04$imgRDDelete"
														id="ContentPlaceHolder1_grSchemeList_imgRDDelete_2"
														src="../images/DeleteRed.png"
														style="height: 20px; width: 20px;" /></td>
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl04$imgBtnSelect"
														id="ContentPlaceHolder1_grSchemeList_imgBtnSelect_2"
														src="dist/img/view-icon.png"
														style="height: 20px; width: 20px;" /></td>
												</tr>
												<tr style="color: #000333; background-color: #F3ACAF;">
													<td>103</td>
													<td>Elite SB Account</td>
													<td>4</td>
													<td>5000</td>
													<td>5000</td>
													<td>2000</td>
													...
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl05$imgRDDelete"
														id="ContentPlaceHolder1_grSchemeList_imgRDDelete_3"
														src="../images/DeleteRed.png"
														style="height: 20px; width: 20px;" /></td>
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl05$imgBtnSelect"
														id="ContentPlaceHolder1_grSchemeList_imgBtnSelect_3"
														src="dist/img/view-icon.png"
														style="height: 20px; width: 20px;" /></td>
												</tr>
												<tr>
													<td>104</td>
													<td>Royal SB Account</td>
													<td>6</td>
													<td>50000</td>
													<td>0</td>
													<td>5000</td>
													...
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl06$imgRDDelete"
														id="ContentPlaceHolder1_grSchemeList_imgRDDelete_4"
														src="../images/DeleteRed.png"
														style="height: 20px; width: 20px;" /></td>
													<td align="center" style="width: 50px;"><input
														type="image"
														name="ctl00$ContentPlaceHolder1$grSchemeList$ctl06$imgBtnSelect"
														id="ContentPlaceHolder1_grSchemeList_imgBtnSelect_4"
														src="dist/img/view-icon.png"
														style="height: 20px; width: 20px;" /></td>
												</tr>
											</table>
