...
<body class="skin-blue sidebar-mini"
	...
	<form method="post"
		action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/AddSaving.aspx"
										...
										<div class="form-group">
											<div class="text-center">
												<img id="imageApplicant" class="profile-user-img"
													src="dist/img/photo.jpg" style="width: 110px;" />
											</div>
										</div>
									</div>
								</div>
										...
										<div class="form-group">
											<div class="text-center">
												<img id="imageSignature" class="profile-user-img"
													src="dist/img/sign.jpg" style="height: 70px; width: 115px;" />
											</div>
										</div>
									</div>
								</div>
