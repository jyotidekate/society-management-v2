...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/AddSaving.aspx" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
...
//]]>
	...
	<option selected="selected" value="100">Basic SB Account</option>
	...
	<option value="104">Royal SB Account</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="openingAmount" type="text" value="500" id="openingAmount" class="form-control" onkeypress="return isNumberOnlyKey(this, event);" />
	...
	<option value="NEFT">NEFT</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <label class="switch">
                                       <input id="chkisactive" type="checkbox" name="chkisactive" checked="checked" />
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="text-center">
                                    <img id="imageApplicant" class="profile-user-img" src="dist/img/photo.jpg" style="width:110px;" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="text-center">
                                    <img id="imageSignature" class="profile-user-img" src="dist/img/sign.jpg" style="height:70px;width:115px;" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="text-center">
                                    <img id="imgJointPhoto" class="profile-user-img" src="dist/img/photo.jpg" style="width:110px;" />
                                </div>
                            </div>
                        </div>
