...
<body class="skin-blue sidebar-mini"
	...
	<form method="post"
		action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/MaturityApplicationDelete.aspx"
		id="form1">
...
//]]>
			...
			<div class="content-wrapper" style="min-height: 1105.75px;">
				<section class="content-header">
					<h1 id="ContentPlaceHolder1_IdHeader">Maturity Application
						Delete</h1>
					<ol class="breadcrumb">
						<li><a href="Home.html"><i class="fa fa-dashboard"></i>Home</a></li>
						<li><a href="#">Dashboard</a></li>
						<li class="active">Application Delete</li>
					</ol>
				</section>
...
<!-- Dk/Admin/MaturityApplicationDelete.aspx EDB D 09:27:14 GMT -->
</html>
