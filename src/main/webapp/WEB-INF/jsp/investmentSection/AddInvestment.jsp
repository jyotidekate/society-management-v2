...
<body class="skin-blue sidebar-mini" onload="SelectClientCodeAddInvesrtment();SelectBranchAddInvesrtment();"
                        ...
                        <div class="box-body">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    ...
                                    <select name="searchMemberCode"
                                       id="id" 
                                       class="form-control select2" style="width: 100%;"  onchange="getByDataBySearchMemberCode();">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <select name="modeOfOp"
                                       id="modeOfOp" class="form-control"
                                       style="width: 100%;">
                                       <option value="">Select</option>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <input name="jointCode"
                                       type="text"
                                      id="jointCode" class="form-control" />
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="txtJointMemberName"
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <label class="switch"> <input
                                       id="chkisSms" type="checkbox"
                                       name="chkisSms" checked="checked" />
