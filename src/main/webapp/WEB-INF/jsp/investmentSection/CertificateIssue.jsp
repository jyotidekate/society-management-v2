...
<body class="skin-blue sidebar-mini"  onload="getAllPolicyNumber1()"  style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <!-- <form method="get" action="" id="form1" modelAttribute="user"> -->
...
//]]>
    ...
    <section class="content-header">
        <h1 id="ContentPlaceHolder1_IdHeader">Certificate Issue</h1>
        <ol class="breadcrumb">
	...
	<option value=""></option>
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <input type="button" onclick="getDataByIssue();" name="ctl00$ContentPlaceHolder1$btnSave" value="Search" id="ContentPlaceHolder1_btnSave" class="btn btn-success pull-right margin-r-5 margin-20" />
