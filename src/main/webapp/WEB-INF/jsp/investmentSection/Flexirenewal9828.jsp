...
<body class="skin-blue sidebar-mini" onload="getAllPolicyNumber1();getfetchbranchinv();" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
                        ...
                        <div class="box-body">
                           <div class="col-md-6">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <select  name="searchbyPolicyNo" id="searchbyPolicyNo"  
                                     class="form-control select2" onchange="searchByPolicyNoFunction()" style="width: 100%;">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <input name="empCode" type="text" readonly="readonly" id="empCode" Placeholder="Enter Emp. Code" class="form-control" />
                           ...
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <input name="searchMemberCode" type="text" readonly="readonly" id="searchMemberCode" class="form-control" Placeholder="Enter Member Code" />
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <input name="phoneno" type="text" readonly="readonly" id="phoneno" class="form-control" Placeholder="Enter Mobile Number" />
                        ...
                        <div class="box-body">
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <input name="balance" type="text" readonly="readonly" id="balance" Placeholder="Enter Plan Balance" class="form-control" />
                                 </div>
                              </div>
                              <div class="form-group row">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-8">
                                    <input name="amount" type="text" id="amount" class="form-control" Placeholder="Enter Amount" onpaste="return false" onkeypress="return isNumberOnlyKey(this, event);" autocomplete="off" />
                              ...
                              <div class="form-group">
                                 <div class="text-center">
                                  <!-- <div id ="signatureAppend">  </div> -->
                                     <img id="secondpreview" src="#" class="profile-user-img" style="height:70px;width:115px;" /> 
