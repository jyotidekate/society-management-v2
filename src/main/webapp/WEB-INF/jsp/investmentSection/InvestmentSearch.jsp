...
<body class="skin-blue sidebar-mini" onload="getAllPolicyNumber1();investmentSearchFunction()" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input name="fDate" type="date" value="" id="fDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input name="tDate" type="date" value="" id="tDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="policyno" type="text" id="policyno" class="form-control" Placeholder="Enter Policy No." autocomplete="off" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Member Code :</label>
                                <input name="searchMemberCode" type="text" id="searchMemberCode" class="form-control" Placeholder="Enter Member Code" autocomplete="off" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="text-center">
                            <a id="ContentPlaceHolder1_btnSearch" class="btn btn-success" onclick="getTableData();" href="javascript:__doPostBack(&#39;ctl00$ContentPlaceHolder1$btnSearch&#39;,&#39;&#39;)"><span class="fa fa-search"></span> SEARCH</a>
