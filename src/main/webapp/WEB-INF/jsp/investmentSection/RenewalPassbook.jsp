...
//]]>
	...
	<option value=""></option>
                             ...
                             <div class="col-md-8">
                                 <div class="form-group">
                                      <label></label>
                                      <input type="submit" onclick="this.disabled = true" name="ctl00$ContentPlaceHolder1$btnHeadline" value="Heading" id="ContentPlaceHolder1_btnHeadline" class="btn btn-danger pull-right margin-r-5 margin-20" />
                                      <input type="submit" onclick="this.disabled = true" name="ctl00$ContentPlaceHolder1$btnBook" value="Transaction" id="ContentPlaceHolder1_btnBook" class="btn btn-info pull-right margin-r-5 margin-20" />
                                      <input type="submit" onclick="this.disabled = true" name="ctl00$ContentPlaceHolder1$btnFrontPage" value="Front Page" id="ContentPlaceHolder1_btnFrontPage" class="btn btn-warning pull-right margin-r-5 margin-20" />
                                      <input type="submit"  name="Save" value="Search" onclick="getDataByPolNofordailyRD();" id="Save" class="btn btn-success pull-right margin-r-5 margin-20" />
