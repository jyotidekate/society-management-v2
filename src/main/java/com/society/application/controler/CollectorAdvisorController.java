...
public class CollectorAdvisorController {
	...
	@ResponseBody
	public ResponseEntity<String> updateThroughSelectedCode(@RequestBody AdvisorCollectorDetails advisor){
		int i = advisorCollectorDetailsRepo.updateThroughid(advisor.getBranchName(), advisor.getSelectPosition(), advisor.getNewSenior(), advisor.getId());
