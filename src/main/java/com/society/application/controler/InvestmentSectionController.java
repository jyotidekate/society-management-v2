...
public class InvestmentSectionController {
	...
	public ResponseEntity<String> updateAddInvestment(  
			...
			@RequestParam("searchMemberCode") String searchMemberCode,
...
//			@RequestParam("misMode") String misode,
			...
			@RequestParam("chkisSms") String chkisSms ,AddInvestment addin) {
				...
				if(!file1.isEmpty()&&!file23.isEmpty()) {
					...
					addin.setPhoto(fileName);
					addin.setSignature(fileName2);
					}
	...
	public String planMaster(Model model, @RequestParam(defaultValue = "0") int page,
			...
			@RequestParam(defaultValue = "0") int page3,
	...
	public ResponseEntity<String> updateBySelectPolicyNo(
			...
			@RequestParam("transactionFor") String transactionFor,
			@RequestParam("remarks") String remarks,
			...
			@RequestParam("balance") String balance	
				...
				if(!file1.isEmpty() && !file2.isEmpty()) {
					...
					int i = addInvestmentRepo.updateThroughid(tDate, branchName, transactionFor, remarks, transactionType, amount, paymode, 
							fileName1, fileName2, id);
				}else {
					int i = addInvestmentRepo.updateThroughidWithoutFile(tDate, branchName, transactionFor, remarks, transactionType, amount, paymode,  id);
				}
	...
	@RequestParam("policyDate1") String policy_date,
	@RequestParam("mDate") String mDate,
	...
	@RequestParam("maturityAmount") String maturityAmount,
	@RequestParam("totalDeposit") String totalDeposit,
	@RequestParam("MaturityAmountDue") String amtDue,
	@RequestParam("chkisSms") String chkisSms,
	@RequestParam("advisorCode") String advisorCode,
	@RequestParam("lastInstPaid") String lastInstPaid,
	@RequestParam("dueDate") String dueDate,
	@RequestParam("latefine") String latefine,
	@RequestParam("NoOfInstPaid") String noOfInstPaid,
	@RequestParam("Paymode") String paymode,
	@RequestParam("collectorCode") String collectorCode,
	@RequestParam("advisorName") String advisorName,
	@RequestParam("remarks") String remarks,
	...
	@RequestParam(name = "searchbyPolicyNo", required = false) Integer searchbyPolicyNo ) {
        ...
        if(!filetag.isEmpty()&&!secondfiletag.isEmpty()) {
    	    ...
    	    int i = addInvestmentRepo.updateThroughIDRenewalDateBranch(fileName,fileName2,noOfInstPaid,paymode,collectorCode,remarks,renewalDate,branchName,searchbyPolicyNo);
    			
    	}
        else
        {
        	 int i = addInvestmentRepo.updateThroughIDRenewalDateBranch2(noOfInstPaid,paymode,collectorCode,remarks,renewalDate,branchName,searchbyPolicyNo);
