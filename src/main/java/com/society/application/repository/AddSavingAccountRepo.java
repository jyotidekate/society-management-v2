...
public interface AddSavingAccountRepo extends JpaRepository<AddSavingAccount, Integer> {
    ...
    int updateTheAddSavingAcoount(@Param("accountNo") String accountNo,@Param("searchMemberCode") String searchMemberCode,@Param("opDate") String opDate,@Param("memberName") String memberName,
			...
			@Param("fileName3") String fileName3);
	
	
    @Modifying
    @Transactional
    @Query("UPDATE AddSavingAccount SET dOB=:dOB, address=:address, jointCode =:jointCode, advisorCode =:advisorCode,chkisSms =:chkisSms,searchMemberCode =:searchMemberCode,opDate =:opDate,memberName =:memberName,relativeName =:relativeName,phoneno =:phoneno,nomineeName =:nomineeName,nage =:nage,nRelation =:nRelation,district =:district,cSPName =:cSPName,state =:state,pin =:pin,modeOfOp =:modeOfOp,jointName =:jointName,jointRelation =:jointRelation,sBPlan =:sBPlan,openingAmount =:openingAmount,advisorName =:advisorName,opFees =:opFees,paymode =:paymode,remarks =:remarks,chkisactive =:chkisactive,chkdebitcard =:chkdebitcard  WHERE accountNo =:accountNo")
    int updateTheAddSavingAcoountWithoutFile(@Param("accountNo") String accountNo,@Param("searchMemberCode") String searchMemberCode,@Param("opDate") String opDate,
    		...
    		@Param("chkisactive") String chkisactive,@Param("chkisSms") String chkisSms,@Param("chkdebitcard") String chkdebitcard);
